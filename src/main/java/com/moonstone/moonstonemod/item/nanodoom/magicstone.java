...
public class magicstone extends Doom {
    ...
    public void appendHoverText(ItemStack pStack, TooltipContext pContext, List<Component> pTooltipComponents, TooltipFlag pTooltipFlag) {
        ...
        if (stack.getTag()!= null) {
            pTooltipComponents.add(Component.translatable(" Damage: "+  stack.getTag().getInt("damage") + "%").withStyle(ChatFormatting.GOLD));
            pTooltipComponents.add(Component.translatable(" Resistance: "+  stack.getTag().getInt("regs") + "%").withStyle(ChatFormatting.GOLD));
            pTooltipComponents.add(Component.translatable(" KnockBack Resistance: "+  stack.getTag().getInt("kok") + "%").withStyle(ChatFormatting.GOLD));
        }
    }
